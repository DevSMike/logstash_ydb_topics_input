...
public class YdbTopicsInputTest {
    ...
    public void testYdbTopicsInputExample() {
        String prefix = "This is message from YDB Topic";
        long eventCount = 5;
        Map<String, Object> configValues = new HashMap<>();
        configValues.put(YdbTopicsInput.PREFIX_CONFIG.name(), prefix);
        configValues.put(YdbTopicsInput.EVENT_COUNT_CONFIG.name(), eventCount);
        Configuration config = new ConfigurationImpl(configValues);
        YdbTopicsInput input = new YdbTopicsInput("test-id", config, null);
